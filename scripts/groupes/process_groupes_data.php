<script>
    $(document).ready(function() {
        ...
        $('#GroupeAddForm').submit(function(e) {
            e.preventDefault();
            var formData = $(this).serialize();
            $.ajax({
                url: 'scripts/groupes/add-groupe.php',
                type: 'POST',
                data: formData,
        ...
        function loadData() {
            $.ajax({
                url: 'scripts/groupes/get-groupes-liste.php',
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    ...
                    $.each(data, function(index, item) {
                        ...
                        rows += '<td>' + item.date_debut + '</td>';
                        rows += '<td>' + item.date_fin + '</td>';
                        rows += '<td style="text-align: center;">' + item.nb_etudiant + '</td>';
